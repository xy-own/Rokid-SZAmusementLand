...
namespace XY.UXR.Gesture
{
    ...
    public class GesPalm : GestureBase
    {
        ...
        private void Update()
        {
            ...
            // 检测左手手掌姿态
            if (leftBean != null && (HandOrientation)leftBean.hand_orientation == HandOrientation.Back
                && (GestureType)leftBean.gesture_type == GestureType.Palm)
            {
            ...
            // 检测右手手掌姿态
            if (rightBean != null && (HandOrientation)rightBean.hand_orientation == HandOrientation.Back
                && (GestureType)rightBean.gesture_type == GestureType.Palm)
            {
